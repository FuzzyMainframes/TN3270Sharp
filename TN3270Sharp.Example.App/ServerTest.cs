...
//                    response.ParseFieldsScreen(currentScreen);
...
//            // Term Type
//            stream.Write(new byte[] { TelnetOptions.IAC, TelnetOptions.DO, TelnetOptions.TERMINAL_TYPE });
//            var x = stream.Read(bytes, 0, bytes.Length);

//            // Term Type Sub-options
//            stream.Write(new byte[] { TelnetOptions.IAC, TelnetOptions.SB, TelnetOptions.TERMINAL_TYPE, 0x01,
//                TelnetOptions.IAC, TelnetOptions.SE });
//            x = stream.Read(bytes, 0, bytes.Length);

//            //DO EOR
//            stream.Write(new byte[] { TelnetOptions.IAC, TelnetOptions.DO, TelnetOptions.EOR });
//            x = stream.Read(bytes, 0, bytes.Length);

//            // DO Binary
//            stream.Write(new byte[] { TelnetOptions.IAC, TelnetOptions.DO, TelnetOptions.BINARY });
//            x = stream.Read(bytes, 0, bytes.Length);

//            // WILL binary, eor
//            stream.Write(new Byte[] { TelnetOptions.IAC, TelnetOptions.WILL, TelnetOptions.EOR,
//                TelnetOptions.IAC, TelnetOptions.WILL, TelnetOptions.BINARY });
//            x = stream.Read(bytes, 0, bytes.Length);
//        }
//    }
//}